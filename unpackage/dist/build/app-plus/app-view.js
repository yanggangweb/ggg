...
var x=['./components/m-icon/m-icon.wxml','./components/m-input.wxml','./components/tki-qrcode/tki-qrcode.wxml','./pages/login/login.wxml','./pages/main/main.wxml','./pages/pwd/pwd.wxml','./pages/reg/reg.wxml','./pages/user/user.wxml'];d_[x[0]]={}
...
var eN=_mz(z,'canvas',['canvasId',2,'class',1,'id',2,'style',3],[],e,s,gg)
cs.pop()
_(tM,eN)
cs.push("./components/tki-qrcode/tki-qrcode.wxml:image:1:195")
var bO=_mz(z,'image',['hidden',6,'src',1,'style',2],[],e,s,gg)
cs.pop()
_(tM,bO)
cs.pop()
_(r,tM)
...
var cW=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:input',6,'class',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
cs.pop()
_(cT,cW)
cs.pop()
_(fS,cT)
...
var b3=_mz(z,'button',['bindtap',21,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var oBB=_mz(z,'view',['class',33,'style',1],[],e,s,gg)
var lCB=_v()
_(oBB,lCB)
...
var xIB=_n('view')
_rz(z,xIB,'class',39,eFB,tEB,gg)
cs.push("./pages/login/login.wxml:image:1:1148")
var oJB=_mz(z,'image',['bindtap',40,'data-event-opts',1,'src',2],[],eFB,tEB,gg)
cs.pop()
_(xIB,oJB)
cs.pop()
_(bGB,xIB)
...
lCB.wxXCkey=2
_2z(z,37,aDB,e,s,gg,lCB,'provider','__i0__','value')
cs.pop()
cs.pop()
_(oR,oBB)
cs.pop()
...
cs.push("./pages/main/main.wxml:view:1:628")
var l5B=_n('view')
_rz(z,l5B,'class',16,e,s,gg)
cs.push("./pages/main/main.wxml:tki-qrcode:1:648")
var a6B=_mz(z,'tki-qrcode',['background',17,'bind:result',1,'class',2,'data-event-opts',3,'data-ref',4,'foreground',5,'icon',6,'iconSize',7,'loadMake',8,'loadingText',9,'lv',10,'onval',11,'pdground',12,'showLoading',13,'size',14,'unit',15,'usingComponents',16,'val',17],[],e,s,gg)
cs.pop()
_(l5B,a6B)
cs.pop()
_(cLB,l5B)
...
var fCC=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:input',6,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],e,s,gg)
cs.pop()
_(o0B,fCC)
cs.pop()
_(b9B,o0B)
...
var hEC=_mz(z,'button',['bindtap',12,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var bMC=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:input',6,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],e,s,gg)
cs.pop()
_(aJC,bMC)
cs.pop()
_(lIC,aJC)
...
var fQC=_mz(z,'m-input',['displayable',-1,'bind:input',14,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],e,s,gg)
cs.pop()
_(oNC,fQC)
cs.pop()
_(lIC,oNC)
...
var cUC=_mz(z,'m-input',['clearable',-1,'bind:input',22,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],e,s,gg)
cs.pop()
_(cRC,cUC)
cs.pop()
_(lIC,cRC)
...
var lWC=_mz(z,'button',['bindtap',28,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var o4C=_mz(z,'button',['bindtap',4,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var c6C=_mz(z,'button',['bindtap',10,'data-event-opts',1,'type',2],[],e,s,gg)
